        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Milestone_MaternityDressTask_MaternityDressTaskId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bust = table.Column<float>(type: "real", nullable: true),
                    Waist = table.Column<float>(type: "real", nullable: true),
                    Hip = table.Column<float>(type: "real", nullable: true),
                    FirstDateOfLastPeriod = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ...
                    WeeksFromUltrasound = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "2e7b5a97e42e4e84a08ffbe0bc05d2ea", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1010), null, false, "Admin", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1010), null },
                    { "5ed8cfa9b62d433c88ab097b6d2baccd", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1010), null, false, "Staff", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1010), null },
                    { "a3cb88edaf2b4718a9986010c5b9c1d7", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1000), null, false, "Manager", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1000), null },
                    { "b8d237b8b6f849988d60c6c3c1d0a943", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(980), null, false, "User", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(980), null },
                    { "bf081015e17a41b8b1cae65b1b17cfdb", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(980), null, false, "BranchManager", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(980), null },
                    { "c9118b99c0ad486dbb18560a916b630c", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(990), null, false, "BranchStaff", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(990), null },
                    { "e5b0f987fbf44608b7a6a2d0e313b3b2", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(990), null, false, "Designer", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(990), null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "08ee8586464b43dd9a4507add95b281c", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1270), null, null, null, "Designer", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "e5b0f987fbf44608b7a6a2d0e313b3b2", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1270), null, "designer@mamafit.com", "designer" },
                    { "1a3bcd12345678901234567890123456", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1240), null, null, null, "Admin", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "2e7b5a97e42e4e84a08ffbe0bc05d2ea", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1240), null, "admin@mamafit.com", "admin" },
                    { "29d72211a9f7480c9812d61ee17c92b9", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1280), null, null, null, "Branch Manager", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "bf081015e17a41b8b1cae65b1b17cfdb", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1280), null, "branchmanager@mamafit.com", "branchmanager" },
                    { "4c9804ecc1d645de96fcfc906cc43d6c", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1260), null, null, null, "Manager", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "a3cb88edaf2b4718a9986010c5b9c1d7", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1260), null, "manager@mamafit.com", "manager" },
                    { "ce5235c40924fd5b0792732d3fb1b6f", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1250), null, null, null, "Staff", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "5ed8cfa9b62d433c88ab097b6d2baccd", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1250), null, "staff@mamafit.com", "staff" },
                    { "eb019fbe31e6449b9b92c89b5c893b03", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1270), null, null, null, "Branch Staff", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "c9118b99c0ad486dbb18560a916b630c", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1270), null, "branchstaff@mamafit.com", "branchstaff" },
                    { "f49aa51bbd304e77933e24bbed65b165", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1280), null, null, null, "User", "u+7jaa75MJns9ST/6FSw4aQU+zSF/iNldvzpJxBFzwk=", false, true, null, null, "b8d237b8b6f849988d60c6c3c1d0a943", "R0kox04KXBTPFFlKjfxIzNeMzlbH1rGO/YJDtl0N894=", new DateTime(2025, 6, 13, 7, 25, 29, 579, DateTimeKind.Utc).AddTicks(1280), null, "user@mamafit.com", "user" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Milestone_MaternityDressTaskId",
                table: "Milestone",
